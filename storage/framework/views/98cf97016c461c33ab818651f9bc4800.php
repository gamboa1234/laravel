...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('normalize.css')); ?>">
    ...
    <div class="contenedor">
        ...
        <aside class="presentacion">
            ...
            <div class="presentacion--imagen">
                <img src="<?php echo e(asset('Imagenes/comi.png')); ?>" alt="Imagen de presentación">
            </div>
        </aside>
        ...
        <main class="comida">
            ...
            <div class="platos">
                ...
                <section id="contacto">
                    ...
                    <form id="formulario-contacto" method="POST" action="procesar.php">
...
</html><?php /**PATH C:\laragon\www\mi-pagina\resources\views/inicio.blade.php ENDPATH**/ ?>